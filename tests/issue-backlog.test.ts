...
describe('buildBacklog', () => {
  ...
  it('maps severity correctly', () => {
    ...
    // log2(15+1) = 4.0, crossCuttingPenalty = 10/15 = 0.667 (count>10)
    // fixMode='torque' so sweepPenalty = 1
    expect(consoleCleaning!.priority).toBeCloseTo(1 * Math.log2(16) * 0.6 * (10/15), 5);
  });
