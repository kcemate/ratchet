...
- `git log --oneline --since='7 days ago'` → 4 commits (see below)
...
- **Evidence:** 51 + 42 + 14 + 10 + 10 = 127 occurrences of JS imports in the coupling list.
...
- **Evidence:** 4 of the top 20 wc-lines entries are test files; vitest appears 86 times as top import.
...
**Attribution:** Architecture review cron (2026-04-15)  