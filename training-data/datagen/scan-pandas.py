...
def analyze_file(filepath):
    ...
    # Check 5: Potential performance issues - N+1 queries pattern
    # Look for loops with database calls (simplified detection)
    content_lower = content.lower()
    if 'for ' in content_lower and ('query' in content_lower or 'filter(' in content_lower or 'get(' in content_lower):
        # Basic detection - would need more sophisticated analysis
        pass
