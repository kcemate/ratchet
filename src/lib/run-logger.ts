...
export class RunLogger {
  ...
  async log(event: AuditEventType, clickNumber: number, data: Record<string, unknown> = {}): Promise<void> {
    await this.dirReady;
  ...
  async logScoreDelta(clickNumber: number, data: { before: number; after: number; delta: number }): Promise<void> {
