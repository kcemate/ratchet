...
const FRAMEWORK_PROFILES: Record<string, FrameworkProfile[]> = {
  ...
  'drizzle-orm': [
    { name: 'drizzle-orm', category: 'Type Safety', weight: 0.85 },
  ],
  typeorm: [
  ...
  'next-auth': [
    { name: 'next-auth', category: 'Security', weight: 0.9 },
  ],
  authjs: [
    { name: 'authjs', category: 'Security', weight: 0.9 },
  ],
};
 ...
 */
export function getFrameworkProfile(
  framework: Framework,
  category: ScoringCategory,
 ...
 */
export function isCategoryAffectedByFramework(
  framework: Framework,
  category: ScoringCategory,
): boolean {
