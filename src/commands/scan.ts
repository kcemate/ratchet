...
/**
 * Run a heuristic scan of the project at `cwd`.
 * Delegates to ClassicEngine — the scoring logic lives in src/core/engines/classic.ts.
 */
...
// --- Language detection (used by command handler for user-facing warning) ---
