...
describe("getByCategory", () => {
  it("returns entries for each of the six categories", () => {
    const categories = ["error-handling", "performance", "code-quality", "security", "type-safety", "testing"] as const;
...
describe("SEED_ENTRIES integrity", () => {
  ...
  it("all categories are valid Ratchet scoring categories", () => {
    const valid = new Set(["error-handling", "performance", "code-quality", "security", "type-safety", "testing"]);
    for (const entry of SEED_ENTRIES) {
