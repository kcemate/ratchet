...
describe('SUBCATEGORY_TIERS fixMode', () => {
  ...
  const torqueExpected = [
    'Coverage', 'Empty catches', 'Console cleanup', 'Dead code',
    'Test quality', 'Function length',
  ];
  ...
  const sweepExpected = [
    'Structured logging', 'Line length', 'Import hygiene', 'Async patterns',
  ];
