...
import { EXPLANATIONS, getExplanation, type Explanation } from "../core/explanations.js";
...
describe("EXPLANATIONS", () => {
  ...
  it("some explanations include an example field", () => {
    const withExample = Object.entries(EXPLANATIONS).filter(([, exp]) => exp.example !== undefined);
